                    ...
                    public void onClick(View view) {
                        ...
                        WorkersPojoModel workersPojoModel =
                                new WorkersPojoModel(roles, name, w_number,
                                        w_mail, address, place, w_category, w_pcode, w_amount,w_staus);
                        workerslist.add(workersPojoModel);

                        reference.child(w_category).setValue(workerslist).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
